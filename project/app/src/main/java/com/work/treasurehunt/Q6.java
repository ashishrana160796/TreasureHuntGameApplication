...
public class Q6 extends Activity {
    ...
    @NonNull public static TextView t6;
    @Override
        ...
        switch (requestCode) {
            ...
            case ZBAR_QR_SCANNER_REQUEST:
                if (resultCode == RESULT_OK) {
                    if(data.getStringExtra(ZBarConstants.SCAN_RESULT).equals("Q6"))
                    		{
                    			Toast.makeText(this, "You Gotcha sixth QR right.", Toast.LENGTH_LONG).show();
