...
public class Q3 extends Activity {
    ...
    @NonNull public static TextView t3;
    @Override
        ...
        switch (requestCode) {
            ...
            case ZBAR_QR_SCANNER_REQUEST:
                if (resultCode == RESULT_OK) {
                    if(data.getStringExtra(ZBarConstants.SCAN_RESULT).equals("Q3"))
                    		{
                    			Toast.makeText(this, "You Gotcha Third QR right.", Toast.LENGTH_LONG).show();
