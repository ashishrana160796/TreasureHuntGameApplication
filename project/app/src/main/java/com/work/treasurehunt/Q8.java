...
public class Q8 extends Activity {
    ...
    @NonNull public static TextView t8;
    @Override
        ...
        switch (requestCode) {
            ...
            case ZBAR_QR_SCANNER_REQUEST:
                if (resultCode == RESULT_OK) {
                    if(data.getStringExtra(ZBarConstants.SCAN_RESULT).equals("Q8"))
                    		{
                    			Toast.makeText(this, "You Gotcha eighth QR right.", Toast.LENGTH_LONG).show();
