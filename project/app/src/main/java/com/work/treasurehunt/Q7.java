...
public class Q7 extends Activity {
    ...
    @NonNull public static TextView t7;
    @Override
        ...
        switch (requestCode) {
            ...
            case ZBAR_QR_SCANNER_REQUEST:
                if (resultCode == RESULT_OK) {
                    if(data.getStringExtra(ZBarConstants.SCAN_RESULT).equals("Q7"))
                    		{
                    			Toast.makeText(this, "You Gotcha seventh QR right.", Toast.LENGTH_LONG).show();
