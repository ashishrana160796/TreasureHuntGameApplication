...
public class Q4 extends Activity {
    ...
    @NonNull public static TextView t4;
    @Override
        ...
        switch (requestCode) {
            ...
            case ZBAR_QR_SCANNER_REQUEST:
                if (resultCode == RESULT_OK) {
                    if(data.getStringExtra(ZBarConstants.SCAN_RESULT).equals("Q4"))
                    		{
                    			Toast.makeText(this, "You Gotcha fourth QR right.", Toast.LENGTH_LONG).show();
